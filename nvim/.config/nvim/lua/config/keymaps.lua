...
vim.keymap.set("n", "<leader>fG", ":FzfLua grep <CR>", ns)
vim.keymap.set("n", "<leader>fw", ":FzfLua grep_cword cwd=$SESS_ROOT <CR>", ns)
vim.keymap.set("n", "<leader>fW", ":FzfLua grep_cword <CR>", ns)
vim.keymap.set("v", "<leader>fv", ":FzfLua grep_visual cwd=$SESS_ROOT <CR>", ns)
vim.keymap.set("v", "<leader>fV", ":FzfLua grep_visual <CR>", ns)
